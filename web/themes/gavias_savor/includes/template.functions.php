<?php
function gavias_savor_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'gavias_savor');
  return $base_url . '/' . $theme_path . '/';
}

function gavias_savor_preprocess_node(&$variables) {
...
function gavias_savor_preprocess_breadcrumb(&$variables){
