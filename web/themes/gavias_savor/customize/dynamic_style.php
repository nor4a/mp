...
?>
    ...
    <?php if(isset($customize['font_family_primary'])  && $customize['font_family_primary'] != '---'){ ?>
        body,
        .post-style-list.small .post-title a, .portfolio-v1 .content .category a, .block.block-blocktabs .ui-widget,
        .block.block-blocktabs .ui-tabs-nav > li > a, .gva-mega-menu .block-blocktabs .ui-widget,
        .widget.gsc-heading .title, .gsc-hover-box .box-title
        {
    ...
    <?php if(isset($customize['font_family_second'])  && $customize['font_family_second'] != '---'){ ?>
        .widget.gsc-heading .title-sub, .widget.gsc-call-to-action .subtitle, .gsc-box-info .content .subtitle,
    ...
    <?php if(isset($customize['body_bg_image'])  && $customize['body_bg_image']){ ?>
        body{
            background-image:url('<?php echo drupal_get_path('theme', 'gavias_savor') .'/images/patterns/'. $customize['body_bg_image']; ?>');
        }
    <?php } ?> 
