   ...
   class gsc_heading{
         ...
         $fields = array(
            ...
            'fields'    => array(
               ...
               array(
                  ...
                  'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="'.base_path().drupal_get_path('theme', 'gavias_savor').'/demo-font/index.html'.'">Custom icon</a>'),
               ),
               array(
                  'id'        => 'align',
                  'type'      => 'select',
      ...
      public static function sc_heading( $attr, $content = null ){
         ...
         <div class="widget gsc-heading <?php print implode($class, ' ') ?>">
            <?php if($sub){ ?><div class="title-sub"><?php print $sub; ?></div><?php } ?>
            ...
            <?php if($desc){ ?><div class="title-desc"><?php print do_shortcode($desc); ?></div><?php } ?>
         </div>
